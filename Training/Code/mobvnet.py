...
if __name__ == '__main__':
    model = timm.create_model('mobilenetv2_100', pretrained=True)  # Use MobileVNet model
    ...
    torch.save(trained_model, f'{model_path}/trained_mobilenetv2.pth')  # Save the state dict